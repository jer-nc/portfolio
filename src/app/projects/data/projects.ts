...
export const projects = [
    ...
    },
    {
        ...
        timestamp: '',
        title: 'Notes App - Fullstack CRUD AWS CDK',
        image: nextCdk,
        imageType: 'cover',
        description: 'Fullstack Note App - Owner Based operations with NextJS 13 and AWS CDK',
        technologies: ['next', 'typescript', 'aws', 'tailwindcss', 'shad'],
        status: 'Active',
        link: 'https://main.d31bb2ix4eqyp8.amplifyapp.com/',
        githubUrl: 'https://github.com/jer-nc/fullstack-notes-api-cdk-nextjs13',
    },
    {
        projectType: PROJECT_TYPE.GITHUB_WEBSITE,
        timestamp: '',
    ...
    },
    {
        ...
        image: nextCdk,
        imageType: 'cover',
        description: 'Fullstack Book App with NextJS 13 and AWS CDK',
        technologies: ['next', 'typescript', 'aws', 'tailwindcss', 'shad'],
        status: 'Active',
